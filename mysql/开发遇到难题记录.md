...
| 资料       | 地址                                                   |
| ---------- | ------------------------------------------------------ |
| 第三方博客 | [link](https://www.php.cn/mysql-tutorials-487882.html) |
...
# thinkphp代码示例
ServiceSpecModel::whereIn("id",$specArrId)->order("field('id',$specArrId)")->select();
```
