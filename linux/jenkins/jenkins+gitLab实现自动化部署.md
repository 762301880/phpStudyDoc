...
| 官网安装手册       | [link](https://www.jenkins.io/zh/doc/book/installing/) |
...
```shell
# docker pull jenkins # 不推荐拉取此镜像拉取之后不管怎么倒腾都会显示少一个插件
...
# 查看文件夹的归属者
ls -nd /var/jenkins/
drwxr-xr-x 14 1000 0 4096 12月 26 11:56 /var/jenkins/
# 运行容器 这一步看到一个 -u root命令日后研究
