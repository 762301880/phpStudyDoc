...
| yansongda/pay **官方文档**v2                                 | [link](https://pay.yansongda.cn/docs/v2/)                    |
...
>
> [网络博客](https://www.kancloud.cn/xhdx_2005/pay_note/2283437)
...
1. **沙箱是模拟环境**，阉割了完整重试机制，不会严格轮询重试
2. 沙箱只**触发一次**回调，你不返回 `success` 它也不会补发
3. 沙箱只为了调试参数、验签、字段，**不模拟完整重试逻辑**
...
[官方文档](https://opensupport.alipay.com/support/FAQ/65b9c845db5f8a0535837572prod)
