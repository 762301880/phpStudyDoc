...
> **可以参考我人生第二个笔记本机械革命无界14pro的分区**   **C盘300G** **D盘700G**
...
| 分区序号 | 容量      | 用途            | 说明                                                         |
| -------- | --------- | --------------- | ------------------------------------------------------------ |
| C 盘     | 150-200GB | 系统分区        | 存放 Windows 系统文件、系统缓存、注册表等。预留足够空间避免系统更新后空间不足（Windows 11 + 常用软件约占 80-120GB，留 20-50GB 冗余）。 **推荐300G** |
