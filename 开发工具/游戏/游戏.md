...
| 名称             | 地址                                   |
| ---------------- | -------------------------------------- |
| yuzu官网         | [link](https://yuzu-mirror.github.io/) |
...
| KNULLI-萤火虫系统 | [link](https://knulli.org/play/quick-start/#installing-knulli)  [github-down](https://github.com/knulli-cfw/distribution/releases/tag/20241204)  [支持的掌机系统查看](https://knulli.org/devices/) |
