...
```shell
docker run  -td --name=kplayer -v /root/docker_data/kplayer/video:/video \
-v  /root/docker_data/kplayer/config.json:/kplayer/config.json \
-v /root/docker_data/kplayer/cache:/kplayer/cache  --restart=always \  
