...
docker run  -itd --name=kplayer -v /www/aliyun/:/www/aliyun/ -v  /root/docker_data/kplayer/:/kplayer/ -v /root/docker_data/kplayer/cache:/kplayer/cache  --restart=always  bytelang/kplayer:latest 
```
